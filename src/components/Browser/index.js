...
class Browser extends Component {
  ...
  searchResults = () => {
    ...
    const filteredResults = browserHistory.filter(eachItem =>
  ...
  deleteItem = clickedId => {
    ...
    const updatedList = browserHistory.filter(
      eachTodo => eachTodo.id !== clickedId,
    )

    this.setState({
      browserHistory: updatedList,
    })
  }
  ...
  render() {
    ...
    const filteredList = this.searchResults()
